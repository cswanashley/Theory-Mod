...
var prg3Speed, qTerms3, gachaValue2, rpgUnlock, workNerf, atkBoost, diceBoost, diceBoost2;
...
var perkData = {
    ...
    21: {
        name: "Libraries",
        info: Localization.getUpgradeMultCustomInfo("$\\textsf{ATK} to Data Collection lemmas$", "2"),
        req: [11],
    },
    22: {
        name: "Calculators",
        info: Localization.getUpgradeMultCustomInfo("$\\textsf{ATK} to Analyzation lemmas$", "2"),
        req: [11],
    },
    23: {
        name: "Data Check Algorithm",
        info: Localization.getUpgradeMultCustomInfo("$\\textsf{ATK} to Evaluation lemmas$", "2"),
        req: [11],
    },
    24: {
        name: "Co-researchers",
        info: Localization.getUpgradeMultCustomInfo("$\\textsf{ATK} to Revision lemmas$", "2"),
        req: [11],
    },
    31: {
        name: "The Internet",
    ...
    41: {
        name: "Experience",
        info: Localization.getUpgradeMultCustomInfo("$\\textsf{ATK}$", "\\frac{\\text{best theory}}{5} + 1"),
        req: [31, 32],
    },
    42: {
        name: "Short Term Memory",
        info: Localization.getUpgradeMultCustomInfo("$\\textsf{ATK}$", "\\frac{\\text{best lemma}}{25} + 1"),
        req: [33, 34],
    },
};
...
var init = () => {
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(3, currency, new ExponentialCost(1e80, Math.log2(120)));
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(4, currency, new ExponentialCost(1e120, 32));
        c4.maxLevel = 16;
    ...
    // b2
    {
        ...
        b2 = theory.createUpgrade(10, currency2, new ExponentialCost(25, Math.log2(2)));
    ...
    // n1
    {
        ...
        n1 = theory.createUpgrade(11, currency2, new ExponentialCost(100, Math.log2(2)));
    ...
    // n2
    {
        ...
        n2 = theory.createUpgrade(12, currency2, new ExponentialCost(1000, Math.log2(1000)));
    ...
    // c5
    {
        ...
        c5 = theory.createUpgrade(13, currency2, new ExponentialCost(1e12, Math.log2(1e6)));
    ...
    // c6
    {
        ...
        c6 = theory.createUpgrade(14, currency2, new ExponentialCost(1e16, Math.log2(1e12)));
    ...
    // c7
    {
        ...
        c7 = theory.createUpgrade(15, currency2, new ExponentialCost(1e32, Math.log2(1e24)));
    ...
    // c8
    {
        ...
        c8 = theory.createUpgrade(16, currency2, new ExponentialCost(1e64, Math.log2(1e48)));
    ...
    // b3
    {
        ...
        b3 = theory.createUpgrade(30, currency3, new ExponentialCost(150, Math.log2(2)));
    ...
    // n3
    {
        ...
        n3 = theory.createUpgrade(31, currency3, new ExponentialCost(500, Math.log2(2)));
    ...
    // n4
    {
        ...
        n4 = theory.createUpgrade(32, currency3, new ExponentialCost(1500, Math.log2(1000)));
    ...
    // c9
    {
        ...
        c9 = theory.createUpgrade(33, currency3, new ExponentialCost(1e12, Math.log2(10)));
    ...
    // c10
    {
        ...
        c10 = theory.createUpgrade(34, currency3, new ExponentialCost(1e18, Math.log2(25)));
    ...
    // c11
    {
        ...
        c11 = theory.createUpgrade(35, currency3, new ExponentialCost(1e30, Math.log2(100)));
    ...
    // c12
    {
        ...
        c12 = theory.createUpgrade(36, currency3, new ExponentialCost(1e50, Math.log2(1000)));
    ...
    // d4
    {
        ...
        d4 = theory.createUpgrade(40, currency3, new ExponentialCost(1e6, 1));
    ...
    // d6
    {
        ...
        d6 = theory.createUpgrade(41, currency3, new ExponentialCost(1e9, 2));
    ...
    // d8
    {
        ...
        d8 = theory.createUpgrade(42, currency3, new ExponentialCost(1e12, 3));
    ...
    // d10
    {
        ...
        d10 = theory.createUpgrade(43, currency3, new ExponentialCost(1e18, 4));
    ...
    // d12
    {
        ...
        d12 = theory.createUpgrade(44, currency3, new ExponentialCost(1e24, 5));
    ...
    // d20
    {
        ...
        d20 = theory.createUpgrade(45, currency3, new ExponentialCost(1e32, 6));
    ...
    
    {
        ...
        let getInfo = () => "Open the booster panel";
        booster = theory.createUpgrade(50, currency3, new FreeCost());
        booster.getDescription = (_) => getDesc();
        booster.getInfo = (amount) => getInfo();
        booster.bought = (amount) => { 
            booster.level -= amount;
            if (!isPopupOpen) showBoosterPopup();
        };
    }
    {
        let getDesc = () => "Perks";
        let getInfo = () => "Open the perk panel";
        perk = theory.createUpgrade(51, currency3, new FreeCost());
        perk.getDescription = (_) => getDesc();
        perk.getInfo = (amount) => getInfo();
        perk.bought = (amount) => { 
            perk.level -= amount;
            if (!isPopupOpen) showPerkPopup();
        };
    }
    ...
    
    {
        ...
        perm13.maxLevel = 100;
        perm13.getDescription = (amount) => Localization.getUpgradeMultCustomDesc("\\rho_1", (perm13.level + 1) + "^{Score}");
    ...
    }
    {
        ...
        perm14.maxLevel = 50;
        perm14.getDescription = (amount) => Localization.getUpgradeMultCustomDesc("\\rho_2", (perm14.level + 1) + "^{Score/2}");
    ...
    }
    {
        ...
        perm15.maxLevel = 25;
        perm15.getDescription = (amount) => Localization.getUpgradeMultCustomDesc("\\rho_3", (perm15.level + 1) + "^{Score/4}");
    ...
    theory.setMilestoneCost(new CompositeCost(9, new LinearCost(25, 30), new CompositeCost(94, new LinearCost(295, 25), new ExponentialCost(2750, .13750352375))));
    ...
    {
        diceBoost2 = theory.createMilestoneUpgrade(18, 10);
        diceBoost2.getDescription = (_) => Localization.getUpgradeIncCustomDesc("\\dot{\\boxdot}$ gain$", "10\\% \\text{ (multiplicative)}");
        diceBoost2.getInfo = (_) => Localization.getUpgradeIncCustomInfo("\\dot{\\boxdot}$ gain$", "10\\% \\text{ (multiplicative)}");
        diceBoost2.boughtOrRefunded = (_) => { updateAvailability(); };
    ...
    theory.createAchievement(62, ac2, "Tomorrowland", "Reach 1e60000 τ.", () => theory.tau >= BigNumber.from("e60000"), 
        () => ((theory.tau + 1).log10().toNumber() / 60000));
    theory.createAchievement(63, ac2, "Library of the Galaxy", "Reach 1e100000 τ.", () => theory.tau >= BigNumber.from("e100000"), 
        () => ((theory.tau + 1).log10().toNumber() / 100000));
    ...
    theory.createAchievement(112, ac3, "Gambilician of the Millenium", "Reach 1e1000 publication multiplier.", () => theory.publicationMultiplier >= BigNumber.from("e1000"),
        () => ((theory.publicationMultiplier + 1).log10().toNumber() / 1000));
    theory.createAchievement(113, ac3, "The Aliens Know You", "Reach 1e2000 publication multiplier.", () => theory.publicationMultiplier >= BigNumber.from("e2000"),
        () => ((theory.publicationMultiplier + 1).log10().toNumber() / 2000));
    theory.createAchievement(114, ac3, "Gambilician of the Eon", "Reach 1e4000 publication multiplier.", () => theory.publicationMultiplier >= BigNumber.from("e4000"),
        () => ((theory.publicationMultiplier + 1).log10().toNumber() / 4000));
...
var updateAvailability = () => {
    ...
    diceBoost.isAvailable = diceBoost2.isAvailable = atkBoost.level > 9 && workNerf.level > 9;
    ...
    perk.isAvailable = stage == 5 && diceMasteries == "####################################";
    booster.isAvailable = stage == 5 && perks[11];
...
var tick = (elapsedTime, multiplier) => {
    ...
    if (prgDice >= 1) {
        ...
        val *= (prgDice * 1.1 ** diceBoost.level).floor();
        val2 *= (prgDice * 1.1 ** diceBoost2.level).floor();
    ...
    minigame.isAutoBuyable = clicker.isAutoBuyable = perk.isAutoBuyable = booster.isAutoBuyable = false;
    ...
    if (rpgUnlock.level > 0) {
        ...
        if (rpgLemma > 0) {
            ...
            let atkMult = BigNumber.ONE * (1 + .15 * atkBoost.level);
            if (perks[11]) atkMult *= (1 + pBoosters[fact] * (perks[31 + fact] ? 2 : 1));
            if (perks[21 + fact]) atkMult *= 2;
            if (perks[41]) atkMult *= rpgTheory / 5 + 1;
            if (perks[42]) atkMult *= rpgBestLemma / 25 + 1;

            ourHealth -= (theirMaxHealth * theirHealth * dt) / dicePoints;
            theirHealth -= (dicePoints2 * ourHealth * dt) / theirMaxHealth * atkMult;
            ...
            ourHealth = (ourHealth + 1 / (dicePoints + 1).pow(0.25) * dt).min(1);
        }
    }
...
var getInternalState = () => {
    let state = `${r[0]} ${r[1]} ${r[2]} ${r[3]} ${q[0]} ${q[1]} ${q[2]} ${q[3]} ${stage} ${r[4]} ${r[5]} ${r[6]} ${r[7]} ${gacha} ${prgGacha} ` +
        ...
        `${rpgBestLemma} ${perkPoints} ${perkPointsBought} ${pBoosters[0]} ${pBoosters[1]} ${pBoosters[2]} ${pBoosters[3]} ${pBoostersBought}|${skillExp.join(" ")}|${Object.keys(perks).join(" ")}`;
    return state;
...
var setInternalState = (state) => {
    ...
    if (values.length > 0) {
        ...
        if (values[0].length > 38) perkPoints = +(values[0][38]);
        if (values[0].length > 39) perkPointsBought = +(values[0][39]);
        if (values[0].length > 40) pBoosters[0] = +(values[0][40]);
        if (values[0].length > 41) pBoosters[1] = +(values[0][41]);
        if (values[0].length > 42) pBoosters[2] = +(values[0][42]);
        if (values[0].length > 43) pBoosters[3] = +(values[0][43]);
        if (values[0].length > 44) pBoostersBought = +(values[0][44]);
    }
    if (values.length > 1) {
    ...
    if (values.length > 2) {
        for (let a = 0; a < values[2].length; a++)
...
var getPrimaryEquation = () => {
    if (stage == 0) {
        ...
        theory.primaryEquationScale = .75;
...
var getSecondaryEquation = () => {
    ...
    if (stage == 1) rVal = `\\dot{\\rho_2} = ${perm1.level > 0 ? "(r_5 + 1)" : ""} \\sum^{8}_{i=5}{r_i}, \\quad \\dot{r_i} = \\frac{-r_i}{${getSkillEffect(9)}}`;
        ...
        let res = "\\begin{matrix}";
        res += rpgLemma ? `\\text{Lemma ${rpgLemma} / 50} \\\\ \\scriptstyle{\\text{` + (perks[11] ? 
            ["Data Collecting...", "Analyzing...", "Evaluating...", "Revising..."][fact] : `Researching...`) + `}}` : `\\text{Tap to begin research}`;
        res += "\\end{matrix}";
...
var getQuaternaryEntries = () => {
    ...
    if (stage == 0) {
        ...
        quaternaryEntries.push(new QuaternaryEntry(rpgTheory > 3 ? rpgTheory - 3 : "", rpgTheory > 3 ? 50 : ""));
        quaternaryEntries.push(new QuaternaryEntry(rpgTheory > 2 ? rpgTheory - 2 : "", rpgTheory > 2 ? 50 : ""));
        quaternaryEntries.push(new QuaternaryEntry(rpgTheory > 1 ? rpgTheory - 1 : "", rpgTheory > 1 ? 50 : ""));
        quaternaryEntries.push(new QuaternaryEntry(rpgTheory, (rpgBestLemma - rpgTheory * 50 + 50).toFixed(2) + " / 50"));
        quaternaryEntries.push(new QuaternaryEntry(rpgTheory + 1, null));
        quaternaryEntries.push(new QuaternaryEntry(rpgTheory + 2, null));
        quaternaryEntries.push(new QuaternaryEntry(rpgTheory + 3, null));
    } else {
        return [];
    }
...
var showBoosterPopup = () => {
    ...
    let costFunc = (x) => BigNumber.TEN.pow(80 + x * 20).pow(x) * BigNumber.from("e1000");
    let cost = costFunc(pBoostersBought);

    let sum = 0;
    let ppText, ppButton, pBoosterButtons = [];

    let types = ["Data Collection", "Analyzation", "Evaluation", "Revision"];

    for (let a = 0; a < 4; a++) {
        pBoosterButtons[a] = ui.createButton({
            heightRequest: 60,
            cornerRadius: 0,
            onClicked: () => {
    ...
    let updateButtons = () => {
        sum = pBoosters.reduce((x, y) => x + y);
        if (ppText) ppText.text = "You have " + sum + " / " + pBoostersBought + " boosters.";
    ...
    let popup = ui.createPopup({
        ...
        content: ui.createStackLayout({
            children: [
                ui.createLatexLabel({ text: "\\textbf{\\textsf{ATK} Boosters}", fontSize: 17, horizontalTextAlignment: TextAlignment.CENTER }), 
                ppText = ui.createLatexLabel({ 
                    horizontalTextAlignment: TextAlignment.CENTER,
                    text: "You have " + sum + " / " + pBoostersBought + " boosters.",
                ...
                ppButton = ui.createButton({ 
                    ...
                    onClicked: () => {
                        if (theory.publicationMultiplier >= cost) {
                            pBoostersBought++;
                            cost = costFunc(pBoostersBought);
                            ppButton.text = "Get 1 at " + cost + " publication multiplier";
                            updateButtons();
                        }
                    },
                }),
                ...
                ui.createBox({ heightRequest: 1, margin: new Thickness(0, 8) }),
                ui.createButton({
                    text: Localization.get("StarPopupRespec"), 
                    onClicked: () => { 
                        pBoosters = [0, 0, 0, 0];
                        updateButtons();
                    } 
...
var showPerkPopup = () => {
    ...
    let costFunc = (x) => BigNumber.TEN.pow(8 + x * 2).pow(x) * 1e160;
    let cost = costFunc(perkPointsBought);

    let pass = (p) => {
        let data = perkData[p];
        if (data.req) for (let req of data.req) if (!perks[req]) {
            return false;
        };
        return true;
    }
    ...
    for (let p in perkData) {
        ...
        if (!lines[line]) {
            lines[line] = ui.createStackLayout({
                orientation: StackOrientation.HORIZONTAL,
                horizontalOptions: LayoutOptions.CENTER,
                children: [],
            })
        }
        lines[line].children = [...lines[line].children, buttons[p] = ui.createButton({
            text: p,
            heightRequest: 48, 
            widthRequest: 48, 
            cornerRadius: 0,
            onClicked: () => {
                ...
                let buyButton = ui.createButton({
                    onClicked: () => {
                        if (perkPoints >= 1 && !perks[p] && pass(p)) {
                            perks[p] = true;
                            perkPoints--;
    ...
    let updateButtons = () => {
        if (ppText) ppText.text = "You have " + perkPoints + " perk points.";
    ...
    let popup = ui.createPopup({
        ...
        content: ui.createStackLayout({
            children: [
                ppText = ui.createLatexLabel({ 
                    horizontalTextAlignment: TextAlignment.CENTER,
                    text: "You have " + perkPoints + " perk points.",
