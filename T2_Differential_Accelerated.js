...
var init = () => {
    ...
    // q3
    {
        ...
        dq3 = theory.createUpgrade(2, currency, new ExponentialCost(3e20, Math.log2(3)));
    ...
    // r1
    {
        ...
        dr1 = theory.createUpgrade(4, currency, new ExponentialCost(1e6, Math.log2(2)));
    ...
    // r3
    {
        ...
        dr3 = theory.createUpgrade(6, currency, new ExponentialCost(1e25, Math.log2(3)));
    ...
    theory.createAutoBuyerUpgrade(2, currency, 1e2);
    ...
    {
        q1Exp = theory.createMilestoneUpgrade(2, 4);
    ...
    {
        r1Exp = theory.createMilestoneUpgrade(3, 4);
...
var getPublicationMultiplier = (tau) => tau.pow(0.202) / BigNumber.TEN;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{0.202}}{10}";
